...
function humanError(e,fallback='Something went wrong. Please try again.'){
  ...
  const map={
    ...
    device_already_joined:'This device already supports a choice in this competition.',
    already_joined:'You already support a choice in this competition.',
    competition_round_not_open:'This competition does not have an open round yet.',
    choice_not_in_current_round:'That choice is not active in the current round.',
    competition_not_open:'This competition is not open for support right now.',
    display_name_required:'Enter your name to continue.',
    device_key_required:'This browser could not create a secure supporter identity. Refresh the page and try again.',
